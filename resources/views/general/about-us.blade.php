...
<div class="px-6 sm:px-16 pt-24">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-end overflow-hidden">
...
<div class="px-6 sm:px-16 py-20" data-aos="fade-down">
    <img src="{{ asset('assets/images/photo-about-us.png') }}" alt="Tentang Nursa Jaya Comp" class="w-full rounded-lg object-cover">
</div>

<div class="px-6 sm:px-16 pb-20 overflow-hidden">
    <h2 class="sm:text-lg text-primary font-semibold mb-8" data-aos="fade-down">Visi</h2>
    <p class="text-secondary text-2xl sm:text-3xl font-bold" data-aos="fade-left">
    ...
    <h2 class="sm:text-lg text-primary font-semibold my-8" data-aos="fade-down">Misi</h2>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" data-aos="fade-right">
...
<!-- Tentang Kami -->
<div class="px-6 sm:px-16 py-20 overflow-hidden">
